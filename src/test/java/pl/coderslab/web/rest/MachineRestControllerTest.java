...
public class MachineRestControllerTest {
    ...
    public void getShouldFetchAllAHalDocument() throws Exception {
        ...
        mockMvc.perform(get("/api/machines")
               ...
               .andExpect(jsonPath("$._embedded.machines[0].welderCustomerId", is(MACHINE_1.getCustomerId())))
               .andExpect(jsonPath("$._embedded.machines[0].welderCustomerShortName", is(MACHINE_1.getCustomerShortName())))
               ...
               .andExpect(jsonPath("$._embedded.machines[1].welderCustomerId", is(MACHINE_2.getCustomerId())))
               .andExpect(jsonPath("$._embedded.machines[1].welderCustomerShortName", is(MACHINE_2.getCustomerShortName())))
    ...
    public void getShouldFetchAHalDocument() throws Exception {
        ...
        mockMvc.perform(get("/api/machines/1")
               ...
               .andExpect(jsonPath("$.welderModelId", is(MACHINE_1.getWelderModelId())))
               .andExpect(jsonPath("$.welderModelName", is(MACHINE_1.getWelderModelName())))
               .andExpect(jsonPath("$.welderCustomerId", is(MACHINE_1.getCustomerId())))
               .andExpect(jsonPath("$.welderCustomerShortName", is(MACHINE_1.getCustomerShortName())))
    ...
    public void putShouldUpdateMachineAndFetchHalDocument() throws Exception {
        ...
        mockMvc.perform(put("/api/machines/1")
               ...
               .andExpect(jsonPath("$.welderModelBrandId", is(MACHINE_AFTER_UPDATE.getWelderModelBrandId())))
               .andExpect(jsonPath("$.welderModelBrandName", is(MACHINE_AFTER_UPDATE.getWelderModelBrandName())))
               .andExpect(jsonPath("$.welderModelId", is(MACHINE_AFTER_UPDATE.getWelderModelId())))
               .andExpect(jsonPath("$.welderModelName", is(MACHINE_AFTER_UPDATE.getWelderModelName())))
               .andExpect(jsonPath("$.welderCustomerId", is(MACHINE_AFTER_UPDATE.getCustomerId())))
               .andExpect(jsonPath("$.welderCustomerShortName", is(MACHINE_AFTER_UPDATE.getCustomerShortName())))
               .andExpect(jsonPath("$.creationDate", is(notNullValue())))
               .andExpect(jsonPath("$.modificationDate", is(notNullValue())))
